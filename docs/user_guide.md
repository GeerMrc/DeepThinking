...
- **顺序思考**: 系统化地进行多步骤思考，支持六种思考类型
- **六种思考类型**: 常规、修订、分支、对比、逆向、假设思考
...
```
请使用对比思考分析 React、Vue、Svelte 三个框架，从学习曲线、性能、生态系统三个维度进行对比
```
...
```
使用逆向思考分析"用户流失率上升"的根本原因，从结果逐步回溯可能的因素
```
...
```
使用假设思考分析：如果服务器负载增加100%，会对系统产生什么影响？
```
